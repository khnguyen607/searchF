    ...
    <div class="container mt-4 pb-sm-5 pb-0">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/baackground_2.png" class="d-block w-100" alt="ảnh">
                        </div>
                        <div class="carousel-item">
                            <img src="img/baackground_1.png" class="d-block w-100" alt="ảnh">
                        </div>
                        <div class="carousel-item">
                            <img src="img/background_3.png" class="d-block w-100" alt="ảnh">
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-12 pl-lg-0">
                <div class="fixed-article">
                    <a href="/" class="item-overlay-text">
                        <img src="img/1.png" class="img-fluid" alt="anh" />
                        <div class="caption">
                            <span>Điểm đến</span>
                ...
                <div class="fixed-article">
                    <a href="/" class="item-overlay-text">
                        <img src="img/2.png" class="img-fluid" alt="ảnh" />
                        <div class="caption">
                                ...
                                <div class="col-md-6">
                                    ...
                                    ?>
                                                <div class="first-post">
                                                    <a href="detail.php?baiviet_id=<?php echo $article_data['baiviet_id']; ?>" class="zoom-img">
                                                        <img src="../backend/uploads/<?php echo $article_data["anh"]; ?>" class="img-fluid" alt="ảnh">
                                                    </a>
                                                    <h3><a href="detail.php?baiviet_id=<?php echo $article_data['baiviet_id']; ?>"><?php echo $article_data["tieude"]; ?></a></h3>
                                ...
                                <div class="col-md-6 mt-3 mt-md-0">
                                    ...
                                    ?>
                                        <div class="item-article-list">
                                            <a href="detail.php?baiviet_id=<?php echo $article_data['baiviet_id']; ?>" class="img-thumb">
                                                <img src="../backend/uploads/<?php echo $article_data['anh']; ?>" alt="ảnh" width="70" height="70" />
                                            </a>
                                            <div class="caption">
                                                <a href="detail.php?baiviet_id=<?php echo $article_data['baiviet_id']; ?>"><?php echo $article_data['tieude']; ?></a>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                var navbarLeftItems = document.querySelectorAll('.zoom-img, .img-thumb');
